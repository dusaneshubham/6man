...
document.getElementById("service-container").addEventListener('click', (event) => {
    setTimeout(() => {
        if (img_slider_first_child.classList.contains('show_class') && third_img_slider_first_child.classList.contains('active')) {
            third_img_slider_first_child.style.opacity = '0';
        } else {
...
let second_timer;
document.getElementById("service-container").addEventListener('mousemove', function (e) {
    console.log("hover");
...
document.getElementById("service-container").addEventListener('click', function (e) {
    setTimeout(() => {
...
document.getElementById("service-container").addEventListener("mousemove", (e) => {
    console.log("hover");
